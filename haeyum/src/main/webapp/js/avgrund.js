		...
		return this.each(function() {
			...
			function activate () {
				...
				setTimeout(function() {
					...
					$('.avgrund-overlay').css('height',$(window).height()+'px');
				}, 100);
				...
				if (options.showClose) {
					$('.avgrund-popin').append('<a href="#" class="avgrund-close" style="top: 6px; right: 10px;">' + options.showCloseText + '</a>');
				}
