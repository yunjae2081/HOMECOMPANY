...
$(document).ready(function(){
	...
	$(document).on("click", ".menu > li[class^='in']", function(){
 	  ...
 	  if(category == 0){
 	   location.href = "${pageContext.request.contextPath}/list/listVideo.do";
 	  }
 	  else{
	...
	<div id="cont">
		<div id="menu-fixed">
			...
			<hr>
			<ul class="menu">
				<li id = '0'><i class="material-icons"><img class="sideBtn" id="0" src="${pageContext.request.contextPath}/images/miniall.png"/></i>
				<p>전체</p></li>  
