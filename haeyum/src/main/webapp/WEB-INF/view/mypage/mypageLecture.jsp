...
function lList(llist){
	...
	$.each(llist,function(index,value){
		...
		Html+="<div style='font-size:20px;'>" +llist[index].lTitle + "</div>"
		...
		Html+="</div><br/>"
		Html+="<span>"
		Html+="<a href='../mindMap/view.do?lNo=" + llist[index].lNo + "'>"
...
function wList(wlist){
	...
	$.each(wlist,function(index,value){
		...
		Html+="<div><img class='icon'src='../images/studyImg.png'></div>"
		Html+="<div style='font-size:20px;'>"+ wlist[index].lTitle+ "</div>"
		...
		Html+="<span>"
		Html+="<a href='../mindMap/view.do?lNo=" + wlist[index].lNo + "'>"
		Html+="<img src='../images/moveIcon.png' style='height: 20px;margin-top: 5px;margin-right: 5px;'>"
		Html+="</a>"
		Html+="</span>"
		Html+="<span>"
