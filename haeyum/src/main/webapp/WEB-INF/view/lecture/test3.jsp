...
<div data-title="REGIST" id = "registBtn" class="alertDiv dialog-box_info" style="display: none; position:fixed; margin:0 auto; top:300px; ">
 	  <h3>등록하시겠습니까?</h3>
	 	<hr class="style15">
 	  <div align="center">
...
<div class="topBanner">
				...
				<div data-title="Create Yure Lecture" class="mindBox_info" style="font-size: 17px;padding-top: 52px;line-height: 32px;">
				  <em></em>
